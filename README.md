...
## Testing
Perform the following steps to test/validate your code:
- Use HTML validator (http://validator.w3.org/) to validate your markup.
- Open website in Internet Explorer, Google Chrome and Mozilla Firefox and perform the following steps.
  -Add items to cart.  Verify the correct number of items appear in the alert message.
  -Enter valid email address in Subscribe form and confirm the message is correct.
  -Enter invalid email address in Subscribe form and confirm a message displays that it is an invalid value.
